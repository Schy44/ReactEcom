                                                ...
                                                <td className="qty">
                                                    <div className="qty-btn d-flex">
                                                        ...
                                                        <div className="quantity">
                                                            <span className="qty-minus" onClick={() => { }}><i className="fa fa-minus" aria-hidden="true"></i></span>
                                                            <input type="number" className="qty-text" id="qty" step="1" min="1" max="300" name="quantity" value="1" />
                                                            <span className="qty-plus" onClick={() => { }}><i className="fa fa-plus" aria-hidden="true"></i></span>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
